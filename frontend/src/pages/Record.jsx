...
function ExerciseSetList({ sets, onUpdate, onDelete, onExpand, onExpandPaired, onAddToGroup, categories, onError, containerClass }) {
...
function SessionSummary({ sets, onUpdateSet, onDeleteSet, onExpandSet, onExpandPairedSet, onAddToGroup, categories, onError }) {
