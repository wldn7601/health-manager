...
export const expandToPaired = (id, { group_type, weight1, reps1, exercise2, weight2, reps2 }) =>
  client.post(`/sets/${id}/expand_paired/`, { group_type, weight1, reps1, exercise2, weight2, reps2 }).then((r) => r.data)
